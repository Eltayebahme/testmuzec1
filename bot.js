...
Playing: ${serverQueue.songs[0].title}`)
        ...
        var embedhelp = new Discord.RichEmbed()
            ...
            .addField("play [YouTube Link/Playlist]", "Usage: `!!play` Description: To play See The YouTube Linke And playlist.", true)
            .addField("play [Suchbegriff(e)]", "Usage: `!!play`<song name> Description: To play Music.", true)
            .addField("skip", "Usage: `!!skip` Description: To skip music.", true)
            .addField("stop", "Usage: `!!stop` Description: To Bot disconnected.", true)
            .addField("song", "Usage: `!!song` Description: To Check The Current playing song.", true)
            .addField("queue", "Usage: `!!queue` Description: To Check The Queue List.", true)
            .addField("volume", "Usage: `!!volume` Description: To See Volume.", true)
            .addField("volume [Wert]", "Usage: `!!volume` Description: To Changes the volume level to the specified value.", true)
            .addField("pause", "Usage: `!!pause` Description: To pause The Current Playing Song.", true)
            .addField("resume", "Usage: `!!resume` Description: To Resume The Paused Song.", true)
            .addField("mute", "Usage: `!!mute` Description: To mute Bot.", true)
            .addField("unmute", "Usage: `!!unmute` Description: To unmute Bot.", true)
            .setColor(['#f9fcfc'])
